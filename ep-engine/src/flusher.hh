...
public:
    ...
    void notifyFlushEvent(void) {
        // by setting pendingMutation to true we are
        // guaranteeing that the given flusher will
        // iterate the entire vbuckets under its shard
        // from the begining and flush for all mutations
